                ...
                @foreach ($packages as $package)
                    <div @class([
                        ...
                        @if ($package->is_free || $paymentActive ||
                            ($package->id == $society->package_id && $society->package_type == ($isAnnual ? 'annual' : 'monthly')) ||
                            ...
                            <li class="border-t border-gray-300 dark:border-gray-600 flex justify-center items-center p-4 text-center">
                                @if($package->id == $society->package_id && ($society->package_type == ($isAnnual ? 'annual' : 'monthly') || !in_array($society->package_type, ['annual', 'monthly'])))
    ...
    <script>
        document.addEventListener('livewire:navigated', () => {
            ...
            $wire.on('redirectToFlutterwave', (params) => {
                ...
                addHiddenInput('society_id', paramsData.society_id);
