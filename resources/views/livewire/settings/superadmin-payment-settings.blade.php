    ...
    <div
            ...
            <ul class="flex flex-wrap -mb-px items-center">
                ...
                <li wire:click="activeSetting('flutterwave')" class="me-2">
                    <span @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'flutterwave'), 'active border-skin-base dark:text-skin-base dark:border-skin-base text-skin-base' => ($activePaymentSetting == 'flutterwave')])>
                        <svg class="h-4 w-4" width="24" height="24" xmlns:x="ns_extend;" xmlns:i="ns_ai;" xmlns:graph="ns_graphs;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 176 144.7" xml:space="preserve">
                            <style type="text/css">
                                .st0{fill:#009A46;}
                                .st1{fill:#FF5805;}
                                .st2{fill:#F5AFCB;}
        ...
        <form wire:submit="submitFormRazorpay">
            <div class="grid gap-6">
                ...
                @if ($razorpayStatus)
                    <div>
                        <x-label for="selectRazorpayEnvironment" :value="__('modules.settings.selectEnvironment')" required/>
                    ...
                    @else
                        <div>
                            <x-label for="testRazorpayKey" value="Test Razorpay KEY" required/>
                        ...
                        <div>
                            <x-label for="testRazorpaySecret" value="Test Razorpay SECRET" required/>
        ...
        <form wire:submit="submitFormStripe">
            <div class="grid gap-6">
                ...
                @if ($stripeStatus)
                    <div>
                        <x-label for="selectStripeEnvironment" :value="__('modules.settings.selectEnvironment')" required/>
                    ...
                    @else
                        <div>
                            <x-label for="testStripeKey" value="Test Stripe KEY" required/>
                        ...
                        <div>
                            <x-label for="testStripeSecret" value="Test Stripe SECRET" required/>
                ...
                @if ($flutterwaveStatus)
                    ...
                    @if ($selectFlutterwaveEnvironment == 'live')
                        <div class="grid grid-cols-2 gap-x-4">
                            <div>
                                <x-label for="flutterwaveKey" value="Flutterwave KEY" required/>
                            ...
                            <div>
                                <x-label for="flutterwaveSecret" value="Flutterwave SECRET" required/>
                        ...
                        <div class="grid grid-cols-2 gap-x-4">
                            <div>
                                <x-label for="flutterwaveHash" value="Flutterwave HASH" required/>
                            ...
                            <div>
                                <x-label for="flutterwaveWebhookKey" value="Flutterwave Webhook Key"/>
                                <x-input-password id="flutterwaveWebhookKey" class="block mt-1 w-full" type="text" wire:model='flutterwaveWebhookKey'/>
                    ...
                    @else
                        ...
                        <div class="grid grid-cols-2 gap-x-4">
                            ...
                            <div>
                                <x-label for="testFlutterwaveWebhookKey" value="Test Flutterwave Webhook Key"/>
                                <x-input-password id="testFlutterwaveWebhookKey" class="block mt-1 w-full" type="text" wire:model='testFlutterwaveWebhookKey'/>
