<div class=" px-4 pt-6 xl:grid-cols-3 xl:gap-4 bg-white dark:bg-gray-900">
    ...
    <div class="mb-4 col-span-full xl:mb-2">
        <nav class="flex mb-5" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <a href="{{ route('owners.index') }}" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">@lang('modules.user.owners')</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">@lang('modules.user.ownerDetails')</span>
                </div>
            </li>
            </ol>
        </nav>
        ...
        <div class="p-4 bg-white block sm:flex items-center justify-between dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full mb-1">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">
                    @lang('modules.user.ownerDetails')</h1>
                ...
                <div class="grid lg:grid-cols-2 lg:gap-6 mb-4">
                    <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        <div class="items-center flex sm:space-x-4 space-x-4">
                            <img class="mb-4 rounded-lg w-20 h-20 sm:mb-0 " src="{{ $user->profile_photo_url }}" alt="Profile">
                            <div class="space-y-3">
                                    ...
                                    <dd>
                                        <ul>
                                            <li class="me-1 inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                                {{ $apartments->isNotEmpty() ? $apartments->pluck('apartment_number')->implode(', ') : '--' }}
                                            </li>
                                        </ul>
                                    </dd>
                                </dl>
    ...
    <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" role="tablist">
            ...
            <li class="me-2">
                <a href="javascript:;" wire:click="setActiveTab('tenants')"
                @class(["inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300", 'border-transparent' => ($activeTab != 'tenants'), 'active border-skin-base dark:text-skin-base dark:border-skin-base text-skin-base' => ($activeTab == 'tenants')])>@lang('menu.tenantManagement')</a>
            </li>
            <li class="me-2">
                <a href="javascript:;" wire:click="setActiveTab('family')"
                @class(["inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300", 'border-transparent' => ($activeTab != 'family'), 'active border-skin-base dark:text-skin-base dark:border-skin-base text-skin-base' => ($activeTab == 'family')])>@lang('modules.user.familyMember')</a>
            </li>
            <li class="me-2">
                <a href="javascript:;" wire:click="setActiveTab('documents')"
                @class(["inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300", 'border-transparent' => ($activeTab != 'documents'), 'active border-skin-base dark:text-skin-base dark:border-skin-base text-skin-base' => ($activeTab == 'documents')])>@lang('modules.user.ownerDocuments')</a>
            </li>
        </ul>
    </div>
    <!-- Tab content -->
    <div id="profile-tabs-content">
        @if ($activeTab === 'apartment')
            @include('owners.show-apartments')
        @elseif ($activeTab === 'tenants')
            @include('owners.show-tenants')
        @elseif ($activeTab === 'family')
            <livewire:owner.owner-family-member :userId="$userId" />
        @elseif ($activeTab === 'documents')
            <livewire:owner.owner-documents :userId="$userId" />
        @endif
    </div>
