<div class="px-4 pt-6 xl:gap-4 dark:bg-gray-900">
    <h3 class="text-lg font-bold dark:text-white mb-4">@lang('modules.user.ownerDocuments')</h3>
        ...
        <div class="grid lg:grid-cols-1 lg:gap-6 mb-4">
            <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="flex items-start space-x-4">
                    <div class="w-1/2">
                        <x-label for="documentName" value="{{ __('modules.user.documentName') }}" required/>
                ...
                <div class="flex w-full pb-4 space-x-4 mt-6">
                    <x-button wire:click="addDocument">@lang('modules.user.add')</x-button>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" wire:key='member-list-{{ microtime() }}'>
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='document-{{ $document['id'] . rand(1111, 9999) . microtime() }}' wire:loading.class.delay='opacity-10'>
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap text-right">
                                    <a href="{{ asset_url_local_s3($document['document']) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-25 transition ease-in-out duration-150">
                                    ...
                                    <a href="{{ asset_url_local_s3($document['document']) }}" download target="_blank" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-25 transition ease-in-out duration-150">
