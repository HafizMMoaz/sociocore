    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center justify-start">
          ...
          <a href="{{ route('superadmin.dashboard') }}" class="flex ltr:ml-2 rtl:mr-24 items-center">
            <img src="{{ societyOrGlobalSetting()->logoUrl }}" class="h-8 ltr:mr-3 rtl:ml-3" alt="App Logo" />
            @if (societyOrGlobalSetting()->show_logo_text)
              <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white hidden lg:block">{{
                Str::limit(societyOrGlobalSetting()->name, 10) }}</span>
            @endif
          </a>
