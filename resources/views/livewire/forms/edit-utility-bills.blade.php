    ...
    <form wire:submit="submitForm">
        ...
        <div class="space-y-4">
            <div>
                ...
                <x-select id="apartmentId" class="block w-full mt-1" wire:model="apartmentId" :disabled="($status == 'paid')" >
            ...
            {{-- <div x-data="{ photoName: null, photoPreview: null, hasNewPhoto: @entangle('hasNewPhoto').live , clearFileInput() { this.photoName = ''; this.photoPreview = ''; this.hasNewPhoto = false; this.$refs.photo.value = ''; @this.set('teamLogo', ''); } }" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="{{ $utilityBill->bill_proof_url }}" alt="{{ 'bill Proof' }}" class="object-cover w-20 h-20 overflow-hidden rounded-full">
                </div>
                @endif
            ...
            {{-- <div x-data="{
                ...
                isPdf() {
                    return this.photoName && this.photoName.endsWith('.pdf');
                }
                ...
                @if ($utilityBill->bill_proof)
                <div class="mt-2" x-show="! photoPreview && ! isPdf()">
                    <img src="{{ $utilityBill->bill_proof_url }}" alt="{{ 'bill Proof' }}" class="object-cover w-20 h-20 overflow-hidden rounded-full">
                </div>
                @endif
