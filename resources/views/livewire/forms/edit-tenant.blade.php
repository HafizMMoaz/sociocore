        ...
        <div class="space-y-4">
            ...
            <div class="flex space-x-4">
                <div class="w-1/2">
                    ...
                    <x-datepicker wire:change='loadAvailableTimeSlots' class="w-full" wire:model.live="contract_start_date" id="contract_start_date" autocomplete="off" placeholder="{{ __('modules.tenant.contractStartDate') }}" />
                ...
                <div class="w-1/2">
                    ...
                    <x-datepicker wire:change='loadAvailableTimeSlots' class="w-full" wire:model.live="contract_end_date" id="contract_end_date" autocomplete="off" placeholder="{{ __('modules.tenant.contractEndDate') }}" />
            ...
            <div class="flex space-x-4 mt-2">
                <div class="w-1/2">
                    ...
                    <x-datepicker wire:change='loadAvailableTimeSlots' class="w-full" wire:model.live="move_in_date" id="move_in_date" autocomplete="off" placeholder="{{ __('modules.tenant.moveInDate') }}" />
                ...
                <div class="w-1/2">
                    ...
                    <x-datepicker wire:change='loadAvailableTimeSlots' class="w-full" wire:model.live="move_out_date" id="move_out_date" autocomplete="off" placeholder="{{ __('modules.tenant.moveOutDate') }}" />
