    ...
    <form wire:submit="submitForm">
        ...
        <div class="space-y-4">
            ...
            {{-- <div x-data="{ photoName: null, photoPreview: null }" x-on:photo-removed.window="photoName = null; photoPreview = null;">
                <input type="file" id="billProof" class="hidden" wire:model="billProof" accept="image/png, image/gif, image/jpeg, image/webp"
                    x-ref="profilePhoto"
                    x-on:change="
        ...
        <div class="flex w-full pb-4 mt-6 space-x-4">
            ...
            <x-button-cancel  wire:click="$dispatch('hideAddCommonAreaBill')" wire:loading.attr="disabled">@lang('app.cancel')</x-button-cancel>
        </div>
    </form>
</div>
