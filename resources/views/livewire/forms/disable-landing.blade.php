<div
    class="mx-4 p-4 m-4 bg-white border border-gray-200 rounded-lg shadow-sm col-span-3 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        ...
        <h3 class="mb-4 text-xl font-semibold dark:text-white">@lang('saas.disableLandingSite')</h3>
        <x-help-text class="mb-6">@lang('saas.disableLandingSiteHelp')</x-help-text>
        ...
        <form wire:submit="submitForm">
            ...
            <div class="border p-4 rounded-lg dark:border-gray-500 space-y-4">
                    ...
                    @if (!$disableLandingSite)
                        <div>
                            <x-label for="landingSiteType" :value="__('saas.landingSiteType')" />
                            <x-select id="landingSiteType" class="mt-1 block w-full" wire:model.live="landingSiteType">
                                <option value="theme">@lang('saas.theme')</option>
                                <option value="custom">@lang('saas.custom')</option>
                            </x-select>
                ...
                <div class="border p-4 rounded-lg dark:border-gray-500 space-y-4">
                    <div>
                        <x-label for="metaKeyword" value="{{ __('saas.metaKeyword') }}" />
                    ...
                    <div>
                        <x-label for="metaDescription" value="{{ __('saas.metaDescription') }}" />
