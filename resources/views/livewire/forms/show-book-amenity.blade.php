<div>
    <div class="grid grid-cols-2 mb-6">
        ...
        <div>
            <x-label value="{{ __('modules.bookAmenity.bookedBy') }}" />
    ...
    <div class="mt-6">
        <x-label value="{{ __('modules.bookAmenity.bookingTimePersons') }}" />
    ...
    <div class="grid grid-cols-2 mb-6">
        <a class="min-h-[20px] w-20 rounded-xl bg-white hover:bg-gray-50 text-gray-700 border p-3 inline-flex flex-col items-center justify-center gap-1 transition-colors dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700"
