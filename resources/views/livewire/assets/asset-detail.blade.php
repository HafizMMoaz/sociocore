<div class="px-4 pt-6 bg-white xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
    ...
    <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" role="tablist">
            ...
            {{-- <li class="me-2">
                ...
                @class(["inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300", 'border-transparent' => ($activeTab != 'family'), 'active border-skin-base dark:text-skin-base dark:border-skin-base text-skin-base' => ($activeTab == 'family')])>@lang('modules.asset.familyMember')</a>
            </li>
            <li class="me-2">
                <a href="javascript:;" wire:click="setActiveTab('documents')"
                @class(["inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300", 'border-transparent' => ($activeTab != 'documents'), 'active border-skin-base dark:text-skin-base dark:border-skin-base text-skin-base' => ($activeTab == 'documents')])>@lang('modules.asset.ownerDocuments')</a>
            </li> --}}
        </ul>
    </div>
    <!-- Tab content -->
    <div id="profile-tabs-content">
        ...
        {{-- @elseif ($activeTab === 'family')
            <livewire:owner.owner-family-member :assetId="$assetId" />
        @elseif ($activeTab === 'documents')
            <livewire:owner.owner-documents :assetId="$assetId" /> --}}
        @endif
    </div>
