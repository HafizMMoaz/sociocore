<div>
    ...
    <div>
        <div class="space-y-4">
            <div>
                <x-label for="maintenance_date" value="{{ __('modules.assets.assetName') }}" />
                <p class="text-gray-700">{{ $assetName }}</p>
            </div>

            <div>
                <x-label value="{{ __('modules.assets.issueTitle') }}" />
                <p class="text-gray-700">{{ $title }}</p>
            </div>

            <div>
                <x-label value="{{ __('modules.assets.issueStatus') }}" />
                <p class="text-gray-700 capitalize">{{ $status }}</p>
            </div>

            <div>
                <x-label value="{{ __('modules.assets.priority') }}" />
                <p class="text-gray-700 capitalize">{{ $priority }}</p>
            </div>

         @if($description)
            <div>
                <x-label value="{{ __('modules.assets.issueDescription') }}" />
