...
class SuperadminPaymentSettings extends Component
{
    ...
    public function setCredentials()
    {
        ...
        $this->flutterwaveWebhookKey = $this->paymentGateway->flutterwave_live_webhook_key;
        $this->testFlutterwaveWebhookKey = $this->paymentGateway->flutterwave_test_webhook_key;
