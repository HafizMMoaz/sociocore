...
class ParkingManagement extends Component
{
    ...
    {
        return (new ParkingExport($this->search, $this->filterApartments))->download('parking-'.now()->toDateTimeString().'.xlsx');
    }
    ...
    public function render()
    {
        ...
        if (! user_can('Show Parking')) {
            $query->where(function ($q) use ($loggedInUser) {
                ...
                ->orWhereHas('apartmentManagement', function ($q) use ($loggedInUser) {
