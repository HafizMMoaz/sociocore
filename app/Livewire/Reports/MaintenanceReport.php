...
class MaintenanceReport extends Component
{
    ...
    public function getMonthWiseData()
    {
        ...
        foreach ($maintenanceManagements as $management) {
            $apartments = MaintenanceApartment::with('apartment')->where('maintenance_management_id', $management->id)->get();
    ...
    {
        $maintenanceManagements = MaintenanceManagement::where('year', $this->selectedYear)->get();
