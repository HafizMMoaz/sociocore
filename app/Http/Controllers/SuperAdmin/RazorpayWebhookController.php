...
class RazorpayWebhookController extends Controller
{
    ...
    protected function paymentAuthorized(array $requestData)
    {
        ...
        $societyID = $subscription->society_id;
        ...
        try {
            ...
            if (!$razorpayInvoice) {
                ...
                $razorpayInvoice->society_id = $society->id;
            ...
            // Change society status active after payment
            $society->status = 'active';
            $society->save();

            $generatedBy = User::whereNull('company_id')->get();

            Notification::send($generatedBy, new SocietyUpdatedPlan($society, $plan->id));
